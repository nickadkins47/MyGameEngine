...
class MyGrid
{
    ...
    size_t inline static const sz_x = 10; //num of chunks wide the world is; x direction
    size_t inline static const sz_y = 10; //num of chunks wide the world is; y direction
