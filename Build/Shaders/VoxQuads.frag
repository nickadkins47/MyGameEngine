...
vec3 t_diffuse = vec3(0.5);
vec3 t_specular = vec3(0.5);
vec3 t_ambient = vec3(0.5);

void get_texture_values()
{
    //TODO rework texture system?? idk
